...
public class MinCostMaxFlow_cankao {
	private int INF;
	private int maxFlow;
	...
	public MinCostMaxFlow_cankao(int asrc, int ades, int[][] acapacity,
	...
	public static void main(String[] args) {
		...
		MinCostMaxFlow_cankao mincost_maxflow = new MinCostMaxFlow_cankao(src, des, capacity,
				cost, nodes, INF);

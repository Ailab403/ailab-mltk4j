...
public class MongoCacheDbBean {
	...
	private static class MongoDbBeanHolder {
		private static final MongoCacheDbBean MONGO_DB_BEAN = new MongoCacheDbBean();
	}

	private MongoCacheDbBean() {
		try {
			if (mongoConnection == null || dbConnection == null) {
				String connectHost = "127.0.0.1:27017";
				String dbName = "ailab-mltk-cache";
	...
	// 返回类实体
	public static final MongoCacheDbBean getMongoDbBean() {
